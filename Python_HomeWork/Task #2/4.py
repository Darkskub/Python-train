...
for i in range(len(dictionary["Фамилия"])):
    ...
    dictionaryDate.append(str(dictionary["Год рождения"][i]) + "-" + str(dictionary["Месяц рождения"][i]) + "-" + str(dictionary["Число рождения"][i]))

dictionaryNew = {"Фамилия Имя": dictionaryNF,
